![postmeterm](https://user-images.githubusercontent.com/104295046/222988628-7a2c0385-f46f-41e1-a930-bf649a4ba3ac.gif)



-- Postmortem example --
# A Postmortem on a video generator Gap (incident #001)
...
Gap website down for 1 hour 41 minutes.
...
![post 2](https://user-images.githubusercontent.com/104295046/222991252-9b622f92-d56c-4fd8-aa9d-714976b77305.jpg)
...
| 17:06 | David calls the service provider but they inform that there is no issue in the datacenter  |
| 17:07 | David insists that we cannot connect with the load balancer |
...
| ----------- | ---- | ----- | --- |
| Update playbook with instructions for responding to load balancer failure | mitigate | Iass | n/a **DONE** |
...
| detect sigle points of failures | prevent | Becky | **DONE** |
| Add a new load balancer as a backup | prevent | Isaac | **DONE** |
